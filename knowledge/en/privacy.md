...
description: "Learn how RoutineForge collects, uses, protects, and retains personal data, and how you can exercise your privacy rights."
...
The controller of your personal data is Ivan Cvetkovic Sole Proprietorship DBCK Consulting Agency, Stanoja Bunuševca 47, 18000 Niš, Serbia. For any privacy questions, email [privacy@routineforge.tech](mailto:privacy@routineforge.tech) or call [+381 64 2311336](tel:+381642311336).

We process data in accordance with the Serbian Personal Data Protection Act (Official Gazette of the Republic of Serbia, No. 87/2018) and the EU General Data Protection Regulation (GDPR).
...
-   **Consultation booking:** first and last name, email address, selected time, and answers entered on the Google Calendar booking page — so that we can organize and hold the discovery call.
...
-   **Consultation booking:** organizing the conversation you requested and preparing a potential collaboration (Article 12 of the Serbian Personal Data Protection Act / Article 6(1)(b) GDPR).
...
On your first visit, the website asks for your consent. Google Analytics does not load until you allow the “Analytics” category (Google Consent Mode v2 — the default state is “denied”). If you decline, the website functions normally without analytics tracking. Google Calendar content loads only when, after submitting the contact form, you choose to book a time.
...
-   access the information we process about you and receive a copy,
-   correct inaccurate information and complete incomplete information,
-   delete information (the “right to be forgotten”),
-   restrict processing and object to processing,
-   data portability,
-   withdraw consent at any time — without affecting the lawfulness of processing before withdrawal.

Send your request to [privacy@routineforge.tech](mailto:privacy@routineforge.tech) — we respond without undue delay and no later than the statutory deadline of 30 days. You also have the right to complain to the Serbian Commissioner for Information of Public Importance and Personal Data Protection ([poverenik.rs](https://poverenik.rs/)), or to the supervisory authority in your country.

## How do we protect information?

The website uses HTTPS encryption, only authorized persons have access to information, and we keep collection to a minimum — the website does not maintain user accounts or visitor databases.

## Changes to this policy

We update this policy when the way we process information changes (for example, if we introduce a new tool). The current version is always available on this page, with the date of the latest update at the top.
